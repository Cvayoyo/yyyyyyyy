...
def main():
    ...
    while True:
        ...
        driver = Driver(uc=True,proxy="socks5://qvucvxh.localto.net:3719",agent="Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36")
